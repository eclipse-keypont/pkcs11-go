...
// Code generated by "go run ./cmd/genconst"; DO NOT EDIT.
// Source: ../internal/headers/pkcs11t.h (OASIS PKCS #11 v3.2). See the repository-root NOTICE.md.

package cryptoki

// ckrNames maps a Cryptoki CK_RV return value to its CKR_ symbol.
var ckrNames = map[Error]string{
	CKR_OK:                               "CKR_OK",
